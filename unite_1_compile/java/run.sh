...
cd ./include_libs
javac -sourcepath ./src -d build/classes/ -cp ./JColor-5.5.1.jar src/ua/com/alevel/test/Freedom.java src/ua/com/alevel/Ukraine.java
java -cp build/classes/:./lib/JColor-5.5.1.jar ua.com.alevel.Ukraine
